...
export default function Home() {
  return (
    <ContainerLayout>
      <h1 className="text-gray-200 text-3xl lg:text-5xl xl:text-7xl text-center tracking-wide leading-snug lg:leading-tight">
        <span className="font-bold">Welcome to TechBlog</span><br />
      ...
      <div className="py-12 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h3 className="text-white mt-3 font-semibold text-2xl lg:text-3xl xl:text-4xl">
